...
export function ProjectCard({ project, index }: ProjectCardProps) {
  return (
    <motion.div
      ...
      whileHover={{ scale: 1.05 }} // Ajouter l'effet d'augmentation de taille lors du survol
    >
      ...
      >
        <h3 className="text-5xl font-bold mb-6 text-white transform translate-y-8">
          {project.title}
        </h3>
        <p className="text-gray-200 mb-10 transform translate-y-8">
          {project.description}
        </p>
